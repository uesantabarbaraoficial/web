...
function inicial() {
    var selectElement = document.getElementById("opcionesi");
    var opcionSeleccionada = selectElement.value;
  
    var textoInput = document.getElementById("textoi").value;
...
function primaria() {
  var selectElement = document.getElementById("opcionesp");
  var opcionSeleccionada = selectElement.value;

  var textoInput = document.getElementById("textop").value;
...
function media() {
  var selectElement = document.getElementById("opcionesm");
  var opcionSeleccionada = selectElement.value;

  var textoInput = document.getElementById("textom").value;
...
function certificacioncc() {
  var selectElement = document.getElementById("opcionescc");
  var opcionSeleccionada = selectElement.value;

  var textoInput = document.getElementById("textocc").value;

  if (opcionSeleccionada === "" || textoInput === "") {
    alert("Por favor selecciona una opción y escriba el Número de Cédula del Representante Legal (PDVSA)");
  } else {
    var enlaceGenerado = "https://uesantabarbaraoficial.github.io/web/documentos/certificacionescupos/" + opcionSeleccionada + textoInput + ".pdf";
    var resultadoElement = document.getElementById("resultado1");
  document.getElementById("resultado1").innerHTML= enlaceGenerado;
  window.location=document.getElementById("resultado1").innerHTML;
}
...
function inicialc() {
   var textoInput = document.getElementById("textoci").value;
